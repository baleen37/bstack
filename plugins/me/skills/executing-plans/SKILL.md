...
- You have a plan from me:writing-plans and your human partner
...
- Tasks are mostly independent — the same precondition as
  me:subagent-driven-development.
...
Prefer me:subagent-driven-development when your human partner
...
The workspace and ledger are shared with me:subagent-driven-development
...
- Each plan owns a workspace: at skill start, run
  ...
  `<repo-root>/.bstack/sdd/`, home to every
...
**REQUIRED SUB-SKILL:** load me:test-driven-development now,
...
- Run `bash scripts/task-start PLAN_FILE N`. It prints the brief
...
order under me:test-driven-development, loaded at setup. A test
...
**REQUIRED SUB-SKILL:** me:verification-before-completion governs
the claim. If any item is missing, the task is not complete: finish it.

### 4. Complete the task

Run `bash scripts/task-done PLAN_FILE N BASE -- <test command>`
...
[Read plan once: docs/plans/feature-plan.md; spec read]
[Resolve workspace: sdd-workspace docs/plans/feature-plan.md — no ledger inside, fresh start]
...
Using me:finishing-a-development-branch.
```
