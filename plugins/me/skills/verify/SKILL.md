...
If the user names a verification environment or execution path (for example `local/alpha/beta/prod`,
Jenkins, batch, Databricks), treat it as scope refinement. Before writing the report, confirm the
