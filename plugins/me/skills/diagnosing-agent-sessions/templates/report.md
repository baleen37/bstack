...
Report path: ~/.bstack/diagnosing-agent-sessions/<session-id>/report.md
...
what would raise it. No statement about what me should do.>
...
- Harness and version:
- Models seen:
- me install root / version / git sha:
