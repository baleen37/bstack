...
- NOT "Users" - Not actionable
- NOT "Do backend work" - Too vague
- NOT "Fix bug" - Lacks specificity
- NOT "API" - Not a task
- NOT "There's an issue with the login page that needs to be addressed" - Too wordy
...
- NOT "Feature works well" - Not specific
- NOT "Code is clean" - Subjective, not testable
- NOT "Fast performance" - Not measurable
- NOT "No bugs" - Too broad
...
Keep it concise - detailed technical specs belong in separate documentation or code comments.
