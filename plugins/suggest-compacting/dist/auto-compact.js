...
// src/suggest-compacting/auto-compact.ts
var DEFAULT_THRESHOLD = 50;
var REPEAT_THRESHOLD = 25;
async function main() {
  ...
  const shouldSuggest = state.count === threshold || state.count > threshold && (state.count - threshold) % REPEAT_THRESHOLD === 0;
  if (shouldSuggest) {
    console.log(`
--- Suggestion ---`);
